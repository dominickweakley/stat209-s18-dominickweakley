...
ggplot(mpg,aes(displ,hwy)) +
  ...
  ggtitle("Miles per Gallon for Various Engine Sizes")
...
I notice Hillary's strongest support comes from the north east and west coast.  
She is much less popular in the deep south and bible belt region.
