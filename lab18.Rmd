...
**Answer**:No they are generally higher, because there are a lot of higher salaries and lower ones that will average to a median number, but that number is not always the most common.
...
```{r}
modelma <- lm_basic(base ~ 1, data = masters)


reg_table(modelma, level = .95)
...
**Answer**: The range of the average age of the victim is 33.07 to 35.65.  The estimated average age of the victim is 33.86.  This 
